...
function FertilizerDetails() {
  ...
  const { id } = useParams();
  const product = fertilizerData.find((item) => item.id === Number(id));
  ...
  if (!product) return (
    <div className="h-screen flex flex-col items-center justify-center">
      ...
      <Link to="/fertilizer" className="mt-4 text-green-600 underline">Back to Fertilizers</Link>
    </div>
  );
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 pt-2">
        ...
        <nav className="flex items-center gap-2 text-[10px] md:text-xs text-gray-500 dark:text-gray-400 mb-4 py-2"> 
          <Link to="/fertilizer" className="hover:text-green-600 flex items-center gap-1 transition-colors">
            <ChevronLeft size={14} /> Back to Fertilizers
          </Link>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 p-8">
              ...
              <div className="space-y-2">
                <span className="text-green-600 font-bold text-xs uppercase tracking-[0.2em]">Eco-Friendly Nutrition</span>
              ...
              {/* SIZE SELECTION - Modern Tiles */}
              <div className="mt-8">
                <div className="flex justify-between items-end mb-4">
                  <h3 className="font-bold text-sm uppercase text-gray-500">Select Packaging Size</h3>
                  <span className="text-xs text-green-600 font-medium">Bulk Discounts Available</span>
                </div>
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white py-4 rounded-2xl font-bold text-lg shadow-xl shadow-emerald-200/50 dark:shadow-none transition-all active:scale-95"
                  >
                    Add to Cart
                  </button>
                </div>
              ...
              <div className="mt-8 grid grid-cols-3 gap-2 border-t border-gray-100 dark:border-gray-700 pt-6">
                <div className="flex flex-col items-center text-center gap-1">
                  ...
                  <span className="text-[10px] font-bold text-gray-500 uppercase">Lab Tested</span>
                </div>
                <div className="flex flex-col items-center text-center gap-1">
                ...
                <div className="flex flex-col items-center text-center gap-1">
                  ...
                  <span className="text-[10px] font-bold text-gray-500 uppercase">7 Day Return</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
                  ...
                  <span className="font-bold">Organic Fertilizer</span>
                </div>
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
                  <span className="text-gray-500">Brand</span>
                  <span className="font-bold">{product.brand || 'AgriSmart Nutri'}</span>
                </div>
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
                  <span className="text-gray-500">Form</span>
                  <span className="font-bold">Granular / Liquid</span>
                </div>
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
