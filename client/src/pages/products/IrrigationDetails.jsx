...
import { ChevronLeft, Star, ShieldCheck, Truck, RotateCcw, Droplets } from 'lucide-react';
...
function IrrigationDetails() {
  ...
  if (!product) return (
    <div className="h-screen flex flex-col items-center justify-center">
      ...
      <Link to="/irrigation" className="mt-4 text-green-600 underline">Back to Irrigation</Link>
    </div>
  );
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 pt-2">
        ...
        <nav className="flex items-center gap-2 text-[10px] md:text-xs text-gray-500 dark:text-gray-400 mb-4 py-2"> 
          <Link to="/irrigation" className="hover:text-green-600 flex items-center gap-1 transition-colors">
            <ChevronLeft size={14} /> Back to Irrigation
          </Link>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 p-8">
              ...
              <div className="space-y-2">
                <span className="text-blue-600 dark:text-blue-400 font-bold text-xs uppercase tracking-[0.2em]">Smart Water Solutions</span>
              ...
              <div className="mt-8">
                <div className="flex justify-between items-end mb-4">
                  ...
                  <span className="text-xs text-blue-600 font-medium">Installation Support</span>
                </div>
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-xl p-1">
                    <button onClick={() => setCount(Math.max(1, count - 1))} className="w-10 h-10 flex items-center justify-center font-bold text-xl hover:text-blue-600 transition">-</button>
                    <span className="w-12 text-center font-bold">{count}</span>
                    <button onClick={() => setCount(count + 1)} className="w-10 h-10 flex items-center justify-center font-bold text-xl hover:text-blue-600 transition">+</button>
                  </div>
                  ...
                  <button
                    ...
                    className="flex-1 bg-slate-900 dark:bg-blue-600 hover:bg-black dark:hover:bg-blue-700 text-white py-4 rounded-2xl font-bold text-lg shadow-xl shadow-gray-200 dark:shadow-none transition-all active:scale-95"
                  >
                    Add to Cart
                  </button>
                </div>
              ...
              <div className="mt-8 grid grid-cols-3 gap-2 border-t border-gray-100 dark:border-gray-700 pt-6">
                <div className="flex flex-col items-center text-center gap-1">
                  ...
                  <span className="text-[10px] font-bold text-gray-500 uppercase">2 Yr Warranty</span>
                </div>
                <div className="flex flex-col items-center text-center gap-1">
                  <Droplets size={20} className="text-gray-400" />
                  <span className="text-[10px] font-bold text-gray-500 uppercase">UV Resistant</span>
                </div>
                <div className="flex flex-col items-center text-center gap-1">
                  <RotateCcw size={20} className="text-gray-400" />
                  <span className="text-[10px] font-bold text-gray-500 uppercase">Expert Setup</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
                  ...
                  <span className="font-bold">Irrigation Systems</span>
                </div>
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
                  <span className="text-gray-500">Brand</span>
                  <span className="font-bold">{product.brand || 'AgriFlow Pro'}</span>
                </div>
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
