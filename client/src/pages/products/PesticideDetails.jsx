...
import { ChevronLeft, Star, ShieldCheck, Truck, RotateCcw, ShieldAlert } from 'lucide-react';
...
function PesticideDetails() {
  ...
  if (!product) return (
    <div className="h-screen flex flex-col items-center justify-center">
      ...
      <Link to="/pesticides" className="mt-4 text-green-600 underline">Back to Pesticides</Link>
    </div>
  );
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 pt-2">
        ...
        <nav className="flex items-center gap-2 text-[10px] md:text-xs text-gray-500 dark:text-gray-400 mb-4 py-2"> 
          <Link to="/pesticides" className="hover:text-green-600 flex items-center gap-1 transition-colors">
            <ChevronLeft size={14} /> Back to Pesticides
          </Link>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 p-8">
              ...
              <div className="space-y-2">
                <span className="text-orange-600 font-bold text-xs uppercase tracking-[0.2em]">High-Efficiency Crop Protection</span>
              ...
              <div className="mt-8">
                <div className="flex justify-between items-end mb-4">
                  <h3 className="font-bold text-sm uppercase text-gray-500">Select Volume</h3>
                  <span className="text-xs text-orange-600 font-medium">Safety Instructions Included</span>
                </div>
              ...
              <div className="mt-8 grid grid-cols-3 gap-2 border-t border-gray-100 dark:border-gray-700 pt-6">
                ...
                <div className="flex flex-col items-center text-center gap-1">
                  ...
                  <span className="text-[10px] font-bold text-gray-500 uppercase">Secure Shipping</span>
                </div>
                <div className="flex flex-col items-center text-center gap-1">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
                  ...
                  <span className="font-bold">Plant Protection</span>
                </div>
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
                  <span className="text-gray-500">Brand</span>
                  <span className="font-bold">{product.brand || 'AgriShield'}</span>
                </div>
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
                  <span className="text-gray-500">Toxic Level</span>
                  <span className="font-bold text-orange-600">Moderate (Class II)</span>
                </div>
                <div className="flex justify-between border-b border-gray-50 dark:border-gray-700 pb-2">
